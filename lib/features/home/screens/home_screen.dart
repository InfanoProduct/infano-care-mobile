...
class _HomeScreenViewState extends State<_HomeScreenView> {
  ...
  Future<void> _fetchDailyQuote() async {
    try {
      ...
      debugPrint('[HomeScreen] Daily quote fetch error (using local rotation): $e');
    }
  }
          ...
          children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: const BorderRadius.all(Radius.elliptical(75, 14)),
                                    boxShadow: [
                                      BoxShadow(
            ...
            Builder(
              builder: (context) {
                ...
                final double horizontalPadding = screenWidth < 360 ? 14.0 : 20.0;
                  ...
                  BlocBuilder<JourneyMapCubit, JourneyMapState>(
                    builder: (context, state) {
                      if (state is JourneyMapLoaded) {
                        ...
                        return const CreativeJourneyHomeCard(isLoading: true);
                      }
...
class RecommendedPeerMentorsSection extends StatefulWidget {
  ...
  @override
  State<RecommendedPeerMentorsSection> createState() => _RecommendedPeerMentorsSectionState();
}

class _RecommendedPeerMentorsSectionState extends State<RecommendedPeerMentorsSection> {
  ...
  final List<Map<String, dynamic>> _mentors = const [
    {
      ...
      'quote': 'Helping girls navigate their journey with empathy, warmth, and care.',
      'fullBio':
    ...
    },
    {
      ...
      'quote': 'Here to listen without judgment and share practical coping tips.',
      'fullBio':
    ...
    },
    {
      ...
      'quote': 'Safe space for honest conversations and real peer encouragement.',
      'fullBio':
  ...
  void _showMentorDetailSheet(BuildContext context, Map<String, dynamic> mentor) {
    AppSoundService.instance.playPop();
            ...
            child: Material(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFB48BA6).withValues(alpha: 0.35), width: 1.5),
                  boxShadow: [
                    BoxShadow(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Colors.white,
                                  shape: BoxShape.circle,
                                  border: Border.all(color: _purpleTheme.withValues(alpha: 0.25), width: 2.5),
                                  boxShadow: [
                                    BoxShadow(
                                      color: _purpleTheme.withValues(alpha: 0.15),
                                      blurRadius: 14,
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: (mentor['badges'] as List<String>).map((badgeText) {
                          return Container(
                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                            decoration: BoxDecoration(
                              color: Colors.white.withValues(alpha: 0.9),
                              borderRadius: BorderRadius.circular(14),
                              border: Border.all(color: _purpleTheme.withValues(alpha: 0.2), width: 1),
                            ),
                            child: Text(
                              badgeText,
                              style: GoogleFonts.nunito(
                      ...
                      Row(
                        children: [
                          ...
                          const Icon(Icons.translate_rounded, size: 15, color: Color(0xFF64748B)),
                          const SizedBox(width: 4),
                          Text(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.mark_email_unread_rounded, size: 18, color: Colors.white),
                              const SizedBox(width: 8),
                              Text(
  ...
  @override
  Widget build(BuildContext context) {
    final filteredMentors = _selectedTopicIndex == 0
        ? _mentors
        : _mentors.where((m) => m['categoryIndex'] == _selectedTopicIndex).toList();
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? _purpleTheme : Colors.white.withValues(alpha: 0.92),
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: isSelected ? _purpleTheme : const Color(0xFFE2E8F0),
                        width: 1.2,
                      ),
                      boxShadow: [
                        BoxShadow(
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: _purpleTheme.withValues(alpha: 0.3),
                                        blurRadius: 10,
                                        offset: const Offset(0, 4),
                                      ),
                                    ],
...
class CommunityPulseChallengeSection extends StatefulWidget {
  ...
  @override
  State<CommunityPulseChallengeSection> createState() => _CommunityPulseChallengeSectionState();
}

class _CommunityPulseChallengeSectionState extends State<CommunityPulseChallengeSection> {
      ...
      if (_currentProgressDays < _totalDays) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
              children: [
                Text(_isCompleted ? '🎉' : '✨', style: const TextStyle(fontSize: 18)),
                const SizedBox(width: 10),
                Expanded(
                  child: Text(
                    _isCompleted
            ...
            backgroundColor: _isCompleted ? const Color(0xFF059669) : _purpleTheme,
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            duration: const Duration(seconds: 3),
          ),
  ...
  @override
  Widget build(BuildContext context) {
    final double progressPercent = _isJoined ? (_currentProgressDays / _totalDays) : 0.33;
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          width: double.infinity,
          decoration: BoxDecoration(
            color: const Color(0xFFF8CAD5), // Requested #F8CAD5 background color
          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                Container(
                  padding: const EdgeInsets.all(24), // Increased padding for spacious elegance
                  color: Colors.white.withValues(alpha: 0.15), // Glass tint layer
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(14),
                              border: Border.all(color: const Color(0xFFE8A2B5), width: 1),
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xFF4A1525).withValues(alpha: 0.05),
                                  blurRadius: 6,
                                  offset: const Offset(0, 2),
                                ),
                              ],
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              shape: BoxShape.circle,
                              border: Border.all(color: const Color(0xFFF43F5E).withValues(alpha: 0.3), width: 1.5),
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xFF4A1525).withValues(alpha: 0.08),
                                  blurRadius: 10,
                                  offset: const Offset(0, 4),
                                ),
                              ],
                              ...
                              children: [
                                Text(
                                  ...
                                  style: GoogleFonts.nunito(
                                    fontSize: 19,
                                    fontWeight: FontWeight.w900,
                                    color: const Color(0xFF4A1525), // Deep rich plum text for contrast
                                    height: 1.25,
                                  ),
                                ),
                                const SizedBox(height: 4),
                                Row(
                                  children: [
                                    const Icon(Icons.group_rounded, size: 14, color: Color(0xFF881337)),
                                    const SizedBox(width: 4),
                                    Text(
                      ...
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFFDB337D)),
                        ),
                      ),
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: _isCompleted
                                  ...
                                  : const [Color(0xFFF43F5E), Color(0xFFDB337D)], // Requested #DB337D Color!
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFFDB337D).withValues(alpha: 0.4),
                                blurRadius: 14,
                                offset: const Offset(0, 5),
                              ),
                            ],
...
class ExploreCirclesHomepageSection extends StatefulWidget {
  ...
  @override
  State<ExploreCirclesHomepageSection> createState() => _ExploreCirclesHomepageSectionState();
}

class _ExploreCirclesHomepageSectionState extends State<ExploreCirclesHomepageSection> {
  ...
  final List<String> _categories = const ["All", "Wellness", "Puberty", "Growth", "Social"];
  ...
  final List<Circle> _fallbackCircles = [
    Circle(
      ...
      description: 'Safe space to chat about period symptoms, tips, and body changes.',
      iconEmoji: '🩸',
      accentColor: '#DB337D',
      isAgeSpecific: false,
      memberCount: 4820,
    ...
    Circle(
      ...
      description: 'Daily mental wellness rituals, relaxation tips, and emotional balance.',
      iconEmoji: '🧘',
      accentColor: '#7C3AED',
      isAgeSpecific: false,
      memberCount: 3250,
    ...
    Circle(
      ...
      description: 'Embrace self-love, celebrate body growth, and boost self-esteem.',
      iconEmoji: '💖',
      accentColor: '#EC4899',
      isAgeSpecific: false,
      memberCount: 5100,
    ...
    Circle(
      ...
      description: 'Share study hacks, defeat exam stress, and encourage each other.',
      iconEmoji: '📚',
      accentColor: '#3B82F6',
      isAgeSpecific: false,
      memberCount: 2940,
  ...
  bool _matchesCategory(Circle circle, String category) {
    ...
    if (category == "Wellness") return name.contains("self-care") || name.contains("mindful") || desc.contains("wellness");
    if (category == "Puberty") return name.contains("period") || name.contains("body") || desc.contains("symptoms");
    if (category == "Growth") return name.contains("teen") || name.contains("power") || desc.contains("growth");
    if (category == "Social") return name.contains("general") || name.contains("chat") || name.contains("lounge");
    return true;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final filtered = displayCircles.where((c) => _matchesCategory(c, categoryName)).toList();
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 4),
                                      Text(
                                        circle.memberCount != null ? '${circle.memberCount}' : 'Community',
                                        style: GoogleFonts.nunito(
                                          fontSize: 11,
                                          fontWeight: FontWeight.w800,
                                          color: const Color(0xFF475569),
                            ...
                            // Description
                            Text(
                              circle.description ?? 'Join the conversation & connect with peers.',
                              style: GoogleFonts.nunito(
                                fontSize: 12,
                                fontWeight: FontWeight.w600,
                                color: const Color(0xFF64748B),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      circle.isJoined ? 'View Circle' : 'Explore & Join',
                                      style: GoogleFonts.nunito(
                                        fontSize: 13.5,
                                        fontWeight: FontWeight.w900,
                                        color: Colors.white,
...
class GoodToKnowHomepageSection extends StatefulWidget {
  ...
  @override
  State<GoodToKnowHomepageSection> createState() => _GoodToKnowHomepageSectionState();
}
...
class _GoodToKnowHomepageSectionState extends State<GoodToKnowHomepageSection> {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data is List) {
        ...
        if (raw.isNotEmpty) {
          ...
          final mapped = raw.asMap().entries.map((entry) {
            final idx = entry.key;
            final item = entry.value as Map;
            return {
              'id': item['id']?.toString() ?? 'art_$idx',
              'title': item['title']?.toString() ?? '',
              'readTime': (item['readTime'] ?? item['time'] ?? '3 min read').toString(),
  ...
  void _openArticleDetailScreen(BuildContext context, Map<String, dynamic> article) {
    AppSoundService.instance.playPop();

    final Map<String, String> mappedArt = {
      'title': article['title']?.toString() ?? '',
      'emoji': article['emoji']?.toString() ?? '📖',
      'time': (article['readTime'] ?? article['time'] ?? '3 min read').toString(),
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: _isLoading
              ? const Center(child: CircularProgressIndicator(color: _purpleTheme))
              : ListView.builder(
                  scrollDirection: Axis.horizontal,
                  physics: const BouncingScrollPhysics(),
                  clipBehavior: Clip.none,
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: const BorderRadius.all(Radius.elliptical(110, 14)),
                  boxShadow: [
                    BoxShadow(
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.playfairDisplay(
                    ...
                    fontWeight: FontWeight.w900,
                    color: const Color(0xFF644D95).withValues(alpha: 0.85), // Lighter soft purple shade
                    letterSpacing: -0.8,
                    height: 1.1,
                  ),
                ),
