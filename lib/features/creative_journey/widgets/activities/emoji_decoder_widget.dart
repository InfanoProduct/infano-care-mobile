...
class _EmojiDecoderWidgetState extends State<EmojiDecoderWidget>
  ...
  void initState() {
    ...
    _spinAnimation = CurvedAnimation(
      ...
      curve: Curves.decelerate,
        ...
        setState(() {
          _currentRotation =
              _baseRotation + (_spinAnimation.value * (_targetRotation - _baseRotation));
        });
      });
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        widget.content['title'] as String? ?? 'Secret Decoder Wheel 🎭',
                        style: GoogleFonts.nunito(fontSize: 17, fontWeight: FontWeight.w900, color: const Color(0xFF9A3412)),
                      ),
                      const SizedBox(height: 4),
                      Text(
                        widget.content['instruction'] as String? ?? 'Spin the wheel to land on each sector and unlock all 4 secret rules!',
          ...
          Text(
            ...
            style: GoogleFonts.nunito(fontSize: 11.5, color: AppColors.textMedium, fontWeight: FontWeight.w800),
          ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: (allUnlocked ? const Color(0xFF10B981) : AppColors.purple).withValues(alpha: 0.35),
                      blurRadius: 14,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(
                      allUnlocked ? Icons.stars_rounded : Icons.autorenew_rounded,
                      color: Colors.white,
                      size: 20,
                    ),
                  ],
  ...
  Widget _buildWheelSection(List<Map<String, dynamic>> scenarios) {
    ...
    final ruleLabels = scenarios.asMap().entries.map((e) {
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFFFDBA74), width: 3.5),
                    boxShadow: [
                      BoxShadow(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Icon(Icons.arrow_drop_down_rounded, color: Colors.white, size: 28),
                  ),
                ),
              ),
            ],
      ...
      child: Column(
        ...
        children: [
          ...
          if (description.isNotEmpty) ...[
            ...
            Text(
              description,
              style: GoogleFonts.nunito(fontSize: 13.5, color: AppColors.textDark, height: 1.5, fontWeight: FontWeight.w600),
            ),
          ],
        ],
      ),
  ...
  Widget _buildQuestionSection() {
    ...
    final correct = _current['correctEmoji'] as String? ?? (options.isNotEmpty ? options.first : '');
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Text(opt, style: GoogleFonts.nunito(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textDark)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Gigi\'s Secret Tip:',
                  style: GoogleFonts.nunito(fontSize: 12.5, fontWeight: FontWeight.w900, color: const Color(0xFF065F46)),
                ),
                const SizedBox(height: 4),
                Text(
                  explanation,
                  style: GoogleFonts.nunito(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFF065F46), height: 1.45),
                ),
              ],
            ),
          ),
