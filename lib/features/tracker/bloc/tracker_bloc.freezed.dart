...
mixin _$TrackerEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(bool isRefresh) load,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(bool isRefresh)? load,
...
class _$LoadImpl implements _Load {
  const _$LoadImpl({this.isRefresh = false});
  ...
  @override
  String toString() {
    return 'TrackerEvent.load(isRefresh: $isRefresh)';
  }
...
abstract class _Load implements TrackerEvent {
  const factory _Load({final bool isRefresh}) = _$LoadImpl;
...
class __$$LoadedImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? recommendedArticles = null,
    ...
    return _then(
      _$LoadedImpl(
        ...
        recommendedArticles: null == recommendedArticles
            ? _value._recommendedArticles
            : recommendedArticles // ignore: cast_nullable_to_non_nullable
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({
    ...
    final List<DailyInsight> dailyInsights = const [],
    final List<Map<String, String>> recommendedArticles = const [],
    this.milestone,
    this.pointsEarned = 0,
    this.isRefreshing = false,
       ...
       _recommendedArticles = recommendedArticles;
  ...
  final List<DailyInsight> _dailyInsights;
  @override
  @JsonKey()
  List<DailyInsight> get dailyInsights {
    if (_dailyInsights is EqualUnmodifiableListView) return _dailyInsights;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_dailyInsights);
  }

  final List<Map<String, String>> _recommendedArticles;
  @override
  @JsonKey()
  List<Map<String, String>> get recommendedArticles {
    if (_recommendedArticles is EqualUnmodifiableListView)
      return _recommendedArticles;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_recommendedArticles);
  }
  ...
  @override
  String toString() {
    return 'TrackerState.loaded(profile: $profile, prediction: $prediction, recentLogs: $recentLogs, history: $history, dailyInsights: $dailyInsights, recommendedArticles: $recommendedArticles, milestone: $milestone, pointsEarned: $pointsEarned, isRefreshing: $isRefreshing)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
              other._dailyInsights,
              _dailyInsights,
            ) &&
            const DeepCollectionEquality().equals(
              other._recommendedArticles,
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_recommendedArticles),
    milestone,
    pointsEarned,
    isRefreshing,
  );
