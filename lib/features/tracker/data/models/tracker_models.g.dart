...
_$CycleProfileModelImpl _$$CycleProfileModelImplFromJson(
  ...
  lastPeriodEnd: json['lastPeriodEnd'] == null
      ? null
      : DateTime.parse(json['lastPeriodEnd'] as String),
  ...
  daysUntilNextPhase: (json['daysUntilNextPhase'] as num?)?.toInt(),
...
Map<String, dynamic> _$$CycleProfileModelImplToJson(
  ...
  'lastPeriodEnd': instance.lastPeriodEnd?.toIso8601String(),
  ...
  'daysUntilNextPhase': instance.daysUntilNextPhase,
...
_$CycleLogModelImpl _$$CycleLogModelImplFromJson(Map<String, dynamic> json) =>
    _$CycleLogModelImpl(
      ...
      vaginalDischarge: json['vaginalDischarge'] as String?,
    );
...
Map<String, dynamic> _$$CycleLogModelImplToJson(_$CycleLogModelImpl instance) =>
    <String, dynamic>{
      ...
      'vaginalDischarge': instance.vaginalDischarge,
    };
