      ...
      sliver: SliverToBoxAdapter(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFFFBCFE8).withValues(alpha: 0.5),
                blurRadius: 12,
                offset: const Offset(0, 4),
              ),
            ],
              ...
              content: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white.withValues(alpha: 0.5), // Transparent white content area
                    ...
                    child: Column(
                      children: [
                        Container(
                          width: 64, height: 64,
                          decoration: BoxDecoration(
                            color: _symptoms.isEmpty ? Colors.white : Colors.white.withValues(alpha: 0.5),
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: GoogleFonts.nunito(color: const Color(0xFF7C3AED).withValues(alpha: 0.5), fontSize: 13),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: isSelected
                        ...
                        : [BoxShadow(color: const Color(0xFFDDD6FE).withValues(alpha: 0.5), blurRadius: 6, offset: const Offset(0, 2))],
                  ),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
